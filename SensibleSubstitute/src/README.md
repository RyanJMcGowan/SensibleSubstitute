...
The `src/` directory contains all front-end code used in the application along with all
tests of such code.
...
This file will not be called. The index file is generated by ASP.Net MVC's Home/Index view.
